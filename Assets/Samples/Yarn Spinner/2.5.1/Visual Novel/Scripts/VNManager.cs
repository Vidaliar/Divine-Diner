...
namespace Yarn.Unity.Example
{
    ...
    public class VNManager : DialogueViewBase
    {
        ...
        void Awake()
        {
            ...
            runner.AddCommandHandler<float>("AddZeusAffinity", AddZeusAffinity);
            runner.AddCommandHandler<float>("AddHermesAffinity", AddHermesAffinity);
            runner.AddCommandHandler<float>("AddHephaestusAffinity", AddHephaestusAffinity);
        ...
        public void SetActor(string actorName, string spriteName, string positionX = "", string positionY = "", string colorHex = "")
        {
            ...
            if (actors.ContainsKey(actorName))
            {
                ...
                // clean-up
                Destroy(actors[actorName].ActorObject);
        ...
        /// <summary>
        /// <br/> PlayAudio( soundName, volume, "loop" ) - plays soundName at volume and loops <br/>
        /// <br/> PlayAudio( soundName, 1.0 ) - plays soundName once at 100% volume <br/>
        /// </summary>
        /// <param name="soundName"> The target sound to play</param>
        /// <param name="volume"> The volume to play the sound at</param>
        /// <param name="loop"> The loop setting, valid input: loop||true </param>
        ...
        /// </summary>
        /// <param name="soundName"> The target sound to stop</param>
        ...
        public void AddZeusAffinity(float amount)
        {
            ...
            affinityYarnBridge.AddZeus(Mathf.RoundToInt(amount));
        }

        public void AddHermesAffinity(float amount)
        {
            if (affinityYarnBridge == null)
            {
                Debug.LogWarning("[VNManager] AffinityYarnBridge is missing.");
            ...
            affinityYarnBridge.AddHermes(Mathf.RoundToInt(amount));
        }

        public void AddHephaestusAffinity(float amount)
        {
            if (affinityYarnBridge == null)
            {
                Debug.LogWarning("[VNManager] AffinityYarnBridge is missing.");
            ...
            affinityYarnBridge.AddHephaestus(Mathf.RoundToInt(amount));
        }
        ...
        /// <param name="onDialogueLineFinished"></param> <summary>
        /// 
        /// </summary>
        /// <param name="dialogueLine"></param>
        /// <param name="onDialogueLineFinished"></param>
        public override void RunLine(LocalizedLine dialogueLine, System.Action onDialogueLineFinished)
        {
            ...
            // Debug.Log($"VN: The character name is: {dialogueLine.CharacterName}");
            ...
            onDialogueLineFinished();			//Invokes the functions subscribed to the event
        }
        ...
        T FetchAsset<T>(string assetName) where T : Object
        {
    ...
    public class VNActor
    {
        ...
        public RectTransform RectTransform { get => actorImage.rectTransform; }
        public GameObject ActorObject { get => actorImage.gameObject; }
